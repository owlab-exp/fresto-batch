...
public class PailReader {
	private static final String newPath = "hdfs://fresto1.owlab.com:9000/fresto/new";
	private static final String masterPath = "hdfs://fresto1.owlab.com:9000/fresto/master";
	...
	public static void readData() throws IOException {
		Pail<FrestoData> frestoDataPail = new Pail<FrestoData>(masterPath);
		int count = 0;
		for(FrestoData fd: frestoDataPail) {
			//System.out.println(fd.pedigree.receivedTime);
			if(fd.dataUnit.isSetEntryOperationCallEdge()) {
				System.out.println(fd.dataUnit.getEntryOperationCallEdge().getTimestamp() + ":" + ++count);
			}
